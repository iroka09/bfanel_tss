        ...
        <Providers initialSession={sessionData}>
          {
            <div className="flex items-center gap-3 w-fit max-w-[80%] mx-auto my-3 px-4 py-3 rounded-xl border border-red-500/30 text-red-400 text-sm font-medium skeleton-wave">
              ...
              <span className="tracking-wide">
                ...
                the official BFanel website, please visit{' '}
                <a
                  href="https://bfanel.com"
                  className="font-bold underline underline-offset-2 text-blue-400/70 dark:text-white/70"
                  target="_blank"
                >
                  bfanel.com
                </a>
...
async function root_metadatas(key = 'all') {
  ...
  const description =
    'B-Fanel Industries manufactures durable plumbing and electrical conduit pipes in multiple sizes for residential, commercial, and industrial construction across Nigeria.'
  const metadata = {
    meta: [
      { title },
      { charSet: 'utf-8' },
      ...
      { name: 'description', content: description },
      {
        name: 'keywords',
        content:
          'Pipes production, Plumbing pipes, Conduit pipes, Pipes supply',
      },
      ...
      // Verification
      {
        ...
        content: 'ZulafKF0UqLIJLvCzrwmpvV1iD93LFrJZocTxwY_mas',
      },
    ],
    //link tags
    links: [
      ...
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Alice&family=Marcellus&display=swap',
      },
