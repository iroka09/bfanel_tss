...
export default function HeroButtons() {
  return (
    <div className="flex flex-col md:flex-row gap-3 w-full">
      <Link
        to={shopNowLink}
        className="inline-grid place-items-center py-2 px-9 text-lg text-white shadow-md rounded-full hover:opacity-80 transition active:translate-y-1.25 w-full bg-linear-to-r from-amber-500 to-secondary font-semibold text-center uppercase"
      >
        Go Shopping
      </Link>
    ...
    <Drawer.Root direction="bottom">
      ...
      <Drawer.Portal>
        <div className="relative flex justify-center z-50">
          ...
          <Drawer.Content className="fixed bottom-0 h-[80%] w-full max-w-175 mx-auto bg-white dark:bg-neutral-900 text-primary p-5 rounded-t-3xl flex flex-col">
            <Drawer.Handle className="shrink-0" />
